...
# Design and implement a simplified building management system using
# object-oriented programming principles. Create classes to represent tenants,
# rent, payment history, apartments, tenant information, policies, and reported maintenance requests.
class Tenant:
